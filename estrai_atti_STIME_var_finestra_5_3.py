...
def configura_file_output_per_modello(nome_modello):
    ...
    file_dataset_csv = output_dir / f"dataset_atti_{slug}_stime_var_finestra_head5_tail3.csv"
    file_dataset_jsonl = output_dir / f"dataset_atti_{slug}_stime_var_finestra_head5_tail3.jsonl"
    file_audit_csv = output_dir / f"audit_log_{slug}_stime_var_finestra_head5_tail3.csv"
